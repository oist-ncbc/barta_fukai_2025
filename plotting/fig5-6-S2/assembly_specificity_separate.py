...
if __name__ == '__main__':
    ...
    plt.savefig('img/feedback.svg', dpi=300, bbox_inches='tight')
    ...
    fig.tight_layout()
    plt.savefig('img/assembly_specificity.png')
    ...
    img = plt.imread(f'plotting/fig5/assembly_feedback_horizontal.png')
    axD.imshow(img)
    ...
    plt.savefig('img/assembly_specificity_supplementary.png', dpi=300)